...
<StaticImage path="/img/graphic-nested-slices.svg" alt="「compose」、「like」、「delete」機能が「post」フォルダにグループ化されています。このフォルダには、禁止を示すために取り消し線が引かれた「some-shared-code.ts」ファイルもあります。" />
...
[layers--layer-definitions]: /ja/docs/reference/layers#layer-definitions
[layers--import-rule]: /ja/docs/reference/layers#import-rule-on-layers
[ref-public-api]: /ja/docs/reference/public-api
